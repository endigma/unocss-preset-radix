...
function getColorValue({ hue, dark = "", step, alpha = "", p3 = "" }) {
...
// src/extendTheme.ts
function extendTheme({ theme, prefix, extend }) {
  var _a, _b, _c, _d;
  const aliasesInUse2 = getAliasesInUse();
  theme.colors = {
    ...
    white: {
      ...
      ...(extend && typeof ((_a = theme == null ? void 0 : theme.colors) == null ? void 0 : _a["white"]) !== "string"
        ? (_b = theme == null ? void 0 : theme.colors) == null
          ? void 0
          : _b["white"]
        : {}),
      DEFAULT: "#ffffff",
    ...
    black: {
      ...(extend && typeof ((_c = theme == null ? void 0 : theme.colors) == null ? void 0 : _c["white"]) !== "string"
...
function isValidAlias({ alias, step, alpha, aliases }) {
  const aliasesInUse2 = getAliasesInUse();
  if (!isValidAliasName(alias)) return false;
  if (!(alias in filterValidAliases(aliases)) && !(alias in aliasesInUse2)) return false;
  if (step === "-fg" && alpha === "A") return false;
  return true;
}
